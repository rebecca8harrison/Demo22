...
font = pygame.font.Font('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/font/myFont.ttf', 32)
big_font = pygame.font.Font('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/font/myFont.ttf', 60)
WIDTH = 900
HEIGHT = 800
...
two_coords = [[], [], []]
three_coords = [[], [], [], []]
menu_img = pygame.image.load('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/menus/mainMenu.png')
game_over_img = pygame.image.load('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/menus/gameOver.png')
pause_img = pygame.image.load('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/menus/pause.png')
for i in range(1, 4):
    bgs.append(pygame.image.load(f'/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/bgs/{i}.png'))
    banners.append(pygame.image.load(f'/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/banners/{i}.png'))
    guns.append(pygame.transform.scale(pygame.image.load(f'/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/guns/{i}.png'), (100, 100)))
    if i < 3:
        for j in range(1, 4):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f'/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/targets/{i}/{j}.png'), (120 - (j * 18), 80 - (j * 12))))
    else:
        for j in range(1, 5):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f'/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/targets/{i}/{j}.png'), (120 - (j * 18), 80 - (j * 12))))
file = open('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/high_scores.txt', 'r')
...
pygame.mixer.init()
pygame.mixer.music.load('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/sounds/bg_music.mp3')
plate_sound = pygame.mixer.Sound('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/sounds/Broken plates.wav')
plate_sound.set_volume(.2)
bird_sound = pygame.mixer.Sound('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/sounds/Drill Gear.mp3')
bird_sound.set_volume(.2)
laser_sound = pygame.mixer.Sound('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/assets/sounds/Laser Gun.wav')
...
while run:
    ...
    if level > 0:
        ...
        if (level == 3 and target_boxes == [[], [], [], []]) or (mode == 1 and ammo == 0) or (
            ...
            game_over = True
    if write_values:
        file = open('/Users/rebeccaharrison/Documents/Python/Bootcamp/ShootingGallery-main/high_scores.txt', 'w')
